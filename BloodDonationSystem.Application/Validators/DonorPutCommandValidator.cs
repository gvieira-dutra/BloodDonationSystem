...
{
    public class DonorPutCommandValidator : AbstractValidator<DonorPutCommand>
    {
        private readonly BloodDonationDbContext _dbContext;

        public DonorPutCommandValidator(BloodDonationDbContext
            dbContext)
        {
            _dbContext = dbContext;
            
            RuleFor(x => x.Id)
                .NotNull().WithMessage("ERROR! Identifier cannot be empty")
                .NotEmpty().WithMessage("ERROR! Identifier cannot be empty");
